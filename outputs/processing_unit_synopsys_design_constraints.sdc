...
# Created by write_sdc on Sat Nov 30 21:38:03 2019
...
set_max_delay 1.5  -to [get_ports input_req]
set_max_delay 1.5  -to [get_ports {output_val[5]}]
set_max_delay 1.5  -to [get_ports {output_val[4]}]
set_max_delay 1.5  -to [get_ports {output_val[3]}]
set_max_delay 1.5  -to [get_ports {output_val[2]}]
set_max_delay 1.5  -to [get_ports {output_val[1]}]
set_max_delay 1.5  -to [get_ports {output_val[0]}]
set_max_delay 1.5  -to [get_ports output_valid]
set_max_delay 1.5  -to [get_ports done]
